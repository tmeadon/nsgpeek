...
var wantedLines = [][]string{
	{"Aug", "9", "10:03:27.725", "DefaultRule_AllowInternetOutBound", "10.0.0.4", "50276", "51.104.229.52", "443", "out", "allow", "end", "2839", "5801"},
	{"Aug", "9", "10:03:27.725", "DefaultRule_AllowInternetOutBound", "10.0.0.4", "47382", "51.105.74.153", "443", "out", "deny", "begin"},
	{"Aug", "9", "10:03:27.725", "DefaultRule_AllowInternetOutBound", "10.0.0.4", "47382", "51.105.74.153", "443", "out", "allow", "continuing", "3769", "5061"},
	{"Aug", "9", "10:03:27.725", "DefaultRule_DenyAllInBound", "117.88.229.255", "50996", "10.0.0.4", "23", "in", "deny", "begin"},
	{"Aug", "9", "10:03:27.725", "DefaultRule_DenyAllInBound", "167.99.14.84", "39984", "10.0.0.4", "8080", "in", "deny", "begin"},
	{"Aug", "9", "10:03:27.725", "DefaultRule_DenyAllInBound", "176.63.187.19", "46852", "10.0.0.4", "23", "in", "deny", "begin"},
	{"Aug", "9", "10:03:27.725", "UserRule_ssh", "38.88.252.187", "59246", "10.0.0.4", "22", "in", "allow", "begin"},
	{"Aug", "9", "10:03:27.725", "UserRule_ssh", "61.177.173.21", "56496", "10.0.0.4", "22", "in", "allow", "begin"},
}

var buffer bytes.Buffer
var testFlowWriter *FlowWriter

func TestMain(m *testing.M) {
	testFlowWriter = NewFlowWriter(&buffer)
